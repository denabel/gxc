...
workflow development has identified five major levers: **indicator type**, **indicator intensity**, **focal time period**, **baseline time period**, and **spatial buffer**. Flexibility on these five attributes should be maximized for users. Thus, the tool offers the functionality to automatically derive **spatio-temporal links** with other georeferenced data typically used in the social sciences, like surveys, digital behavioral data or socio-economic indicators.
